  ...
  return (
    <svg width={size} height={size} viewBox={`0 0 ${size} ${size}`}>
      ...
      <text
        ...
        style={{
          font: "700 10px var(--tk-font-sans)",
          fill: "var(--tk-ink-900)",
        }}
      >
        {value}%
...
function ContactCell({ c }) {
  return (
    <span
      ...
      title={`${c.contactName} · ${c.contactPhone} · ${c.contactEmail}`}
    >
      <span
        style={{
          ...wrap,
      ...
      <span className="tk-meta" style={ellipsis}>
        {c.contactPhone}
      </span>
      <span className="tk-meta" style={ellipsis}>
        {c.contactEmail}
...
export function TruckCompanies() {
  ...
  const filtered = useMemo(
    () =>
      companies.filter((c) => {
        const matchesQ =
          !q ||
          [c.name, c.regNo, c.contactEmail, c.contactPhone].some((v) =>
        ...
        return (
          matchesQ && matchesStatus && matchesVerification && matchesLocation
        );
      }),
  ...
  const avgPerformance = useMemo(() => {
    ...
    return scored.length
      ? Math.round(
          scored.reduce((s, c) => s + c.performance, 0) / scored.length,
        )
      : 0;
  }, [companies]);
    ...
    <>
      ...
      >
        <StatCard
          ...
          delta={companyStats.totalCompaniesDelta}
        ...
        <StatCard
          ...
          delta={companyStats.activeCompaniesDelta}
          caption="vs last month"
        />
        <StatCard
          icon="shield-check"
          ...
          delta={companyStats.verifiedCompaniesDelta}
          caption="vs last month"
        />
        <StatCard
          icon="truck"
          tint="navy"
          label="Total Trucks"
          value={companyStats.totalTrucks}
          delta={companyStats.totalTrucksDelta}
          caption="vs last month"
        />
        <StatCard
          icon="truck"
          tint="amber"
          label="Active Trucks"
          value={companyStats.activeTrucks}
          delta={companyStats.activeTrucksDelta}
          caption="vs last month"
        />
        <StatCard
          icon="user"
          tint="teal"
          label="Total Drivers"
          value={companyStats.totalDrivers}
          delta={companyStats.totalDriversDelta}
          caption="vs last month"
        />
      </div>
      ...
      <Card pad="none">
        <TableToolbar
          search={
            <SearchField
              placeholder="Search companies by name, email, phone, RC number..."
              value={q}
            ...
            columns={[
              ...
              },
              {
                ...
                render: (r) => (
                  <span
                    style={{
                      font: "600 13px/1 var(--tk-font-sans)",
                      color: "var(--tk-blue)",
                    }}
                  >
                    {r.trucks}
              ...
              },
              {
                ...
                header: "Score",
                width: 70,
                render: (r) => <PerformanceRing value={r.performance} />,
              },
          ...
          <SectionCard title="Company Overview">
            ...
            >
              ...
              <span className="tk-meta">
                Truck companies are the backbone of operations. Verify, manage
                fleet capacity, performance and compliance.
              </span>
            </div>
            <div
              style={{
            ...
            >
              ...
              >
                ...
                >
                  {companyStats.totalTrucks.toLocaleString()} Trucks
                </span>
              </div>
              <div
                style={{
              ...
              >
                ...
                >
                  {companyStats.totalDrivers.toLocaleString()}
                </span>
              </div>
              <div
                style={{
              ...
              >
                ...
                >
                  {companyStats.activeTrucks.toLocaleString()} Trucks
                </span>
              </div>
            </div>
            <Button
      ...
      >
        <div style={{ display: "grid", gap: 14 }}>
          <TextField
            label="Company Name"
            required
            placeholder="e.g. Meridian Freight Ltd"
            value={form.name}
            onChange={(e) => setForm((f) => ({ ...f, name: e.target.value }))}
          />
          <TextField
            label="Registration No."
            placeholder="e.g. RC 9012345"
            value={form.regNo}
