...
const ALERTS = [
  {
    icon: "wallet",
    title: "Payouts awaiting release",
    description: "Approved and ready for release",
    count: 8,
    route: "/wallets",
  },
  {
    icon: "wrench",
    tone: "amber",
    title: "Trucks due for maintenance",
  ...
  },
  {
    icon: "lock-open",
    tone: "amber",
    title: "Provisional releases expiring",
...
export function Dashboard() {
  ...
  const series = [
    {
      name: metric,
      color: ACTIVITY[metric].color,
      points: ACTIVITY[metric].points.map((p) => Math.round(p * mult)),
    },
  ];
    ...
    <>
      ...
      >
        ...
        >
          <Tabs
            value={metric}
            onChange={setMetric}
            items={["Jobs", "Trips", "Revenue", "Signups"]}
        ...
        <MapPanel
          ...
          status="687 active trips"
          height={240}
          onExpand={() => setMapOpen(true)}
          legend={[
            { label: "In Transit", color: "var(--tk-blue)" },
        ...
        >
          ...
          >
            <span className="tk-meta">
              ...
              <br />
              The design system ships the panel chrome only.
            </span>
          </div>
        </MapPanel>
      </div>
      ...
      >
        <SectionCard
          ...
          pad="none"
          action={
            <a onClick={() => navigate("/jobs")} style={{ cursor: "pointer" }}>
              View all
            </a>
          }
        >
            ...
            columns={[
              {
                key: "id",
                header: "Job ID",
                render: (r) => <Link to={`/jobs/${r.id}`}>{r.id}</Link>,
              },
                ...
                render: (r) => (
                  <span style={{ position: "relative" }}>
                    <IconButton
                      ...
                      onClick={(e) => {
                        e.stopPropagation();
                        setRowMenuFor(rowMenuFor === r.id ? null : r.id);
                      }}
                    />
                    {rowMenuFor === r.id && (
                      <span
                        ...
                        <DropdownMenu
                          ...
                          items={[
                              ...
                              : []),
                            {
                              ...
                              icon: "ban",
                              tone: "danger",
                              onClick: () => handleJobAction(r, "cancel"),
                            },
                          ]}
                        />
                      </span>
      ...
      >
        <SectionCard title="Fleet Utilization">
          <div style={{ display: "grid", justifyItems: "center", gap: 14 }}>
            <DonutChart
              ...
              data={[
                { label: "On Trips", value: 687 },
                { label: "Available", value: 214 },
                { label: "In Maintenance", value: 48 },
                { label: "Out of Service", value: 21 },
              ]}
            />
            <LegendList
              style={{ width: "100%" }}
        ...
        <SectionCard title="Top Routes by Volume">
          <RankBarList
            items={[
              { label: "Lagos → Kano", value: 342 },
              { label: "Apapa → Ibadan", value: 256 },
              { label: "Onne → Abuja", value: 198 },
              { label: "Lagos → Kaduna", value: 176 },
      ...
      <Modal
        ...
        title="Live Fleet Map"
        description="687 active trips across the network"
        width={720}
      >
        <div
          style={{
      ...
      <Modal
        ...
        title="Alerts & Pending Actions"
        description="Everything currently waiting on admin review."
        width={560}
      >
